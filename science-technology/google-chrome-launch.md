...
- [Apple App Store Launch](apple-app-store-launch.md) — Launched two months earlier in July 2008, the App Store and Chrome both redefined the software distribution and application-runtime landscape; Chrome made the web itself a platform for application delivery, parallel to what the App Store did for mobile.
- [HTC Dream and the Launch of Android](htc-dream-android-launch.md) — Google's Android OS launched in October 2008 on the HTC Dream, weeks after Chrome's debut; both reflected Google's platform-layer strategy to ensure its services ran on every computing surface.
- [Netflix Expands Streaming to Xbox 360](netflix-streaming-video.md) — Chrome's fast JavaScript engine made browser-based streaming players far more viable; in the years that followed Netflix would deprecate its Silverlight plugin in favor of HTML5 video, a transition Chrome's performance helped make commercially feasible.
- [Bitcoin Whitepaper Published](bitcoin-whitepaper.md) — Published weeks after Chrome's launch (October 2008), Bitcoin also bet on the open internet as a platform for a new type of application, illustrating 2008 as a year when the web's future was being actively contested and redesigned.
