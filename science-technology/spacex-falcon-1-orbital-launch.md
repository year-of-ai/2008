---
title: "SpaceX Falcon 1 First Orbital Launch"
date: 2008-09-28
...
**Category**: Science & Technology
**Key figures**: Elon Musk (CEO and chief designer, SpaceX), Gwynne Shotwell (President, SpaceX), Hans Koenigsmann (Vice President of Mission Assurance)
...
- [SpaceX Successfully Launches Falcon 1 Rocket Into Orbit — Space.com](https://www.space.com/5905-spacex-successfully-launches-falcon-1-rocket-orbit.html)
- [Falcon — Britannica](https://www.britannica.com/technology/Falcon-launch-vehicle)
- [SpaceX: the closest Elon Musk bankruptcy story — Slidebean](https://slidebean.com/story/elon-musk-bankruptcy)

<!-- BEGIN GENERATED: crossrefs — maintained by build-structure; do not edit by hand -->
## Related

- [Large Hadron Collider First Beam](large-hadron-collider-first-beam.md) — The LHC's first beam occurred just 18 days before Falcon 1's orbital success, making September 2008 an extraordinary month for science and technology.
- [Lehman Brothers Collapse](../society-economics/lehman-brothers-collapse.md) — The same fortnight that saw SpaceX's triumph also saw the collapse of Lehman Brothers, illustrating the contrasting trajectories of 2008.
